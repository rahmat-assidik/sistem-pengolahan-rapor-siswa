...
@section('content')
    <div class="max-w-full" x-data="{ 
        ...
        {{-- Modal Import Kelas --}}
        <x-modal name="openImport" title="Import Data Kelas (Excel/CSV)">
            <div class="mb-4 text-sm text-gray-600">
                Pastikan format file sesuai. 
                <a href="{{ asset('templates/template_kelas.csv') }}" class="text-blue-600 font-semibold hover:underline" target="_blank" download>Download Template CSV</a>
            </div>
            <form action="{{ route('data_kelas.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
