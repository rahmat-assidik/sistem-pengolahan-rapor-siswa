    ...
    <div class="max-w-full" x-data="{ 
        ...
        <x-modal name="openTambah" title="Tambah Guru Baru">
            <form action="{{ route('data_guru.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Gelar Akademik</label>
                        <input type="text" name="gelar_akademik" placeholder="Contoh: S.Pd, S.Si" class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded focus:border-gray-900 outline-none transition-colors bg-gray-50">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">No Telp</label>
                        <input type="text" name="no_telp" placeholder="Masukkan nomor telepon" class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded focus:border-gray-900 outline-none transition-colors bg-gray-50">
                    </div>
                    <div>
        ...
        <x-modal name="openEdit" title="Edit Data Guru">
            <form :action="`/data_guru/${selectedGuru.id}`" method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">NIP/Kode Guru</label>
                        <input type="text" name="nip" x-model="selectedGuru.nip" required class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded focus:border-gray-900 outline-none transition-colors bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Nama Lengkap</label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Gelar Akademik</label>
                        <input type="text" name="gelar_akademik" x-model="selectedGuru.gelar_akademik" class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded focus:border-gray-900 outline-none transition-colors bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Jenis Kelamin</label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">No Telp</label>
                        <input type="text" name="no_telp" x-model="selectedGuru.no_telp" class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded focus:border-gray-900 outline-none transition-colors bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Status</label>
        ...
        <x-modal name="openLihat" title="Detail Informasi Guru">
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 py-2 border-b border-gray-50">
                    <span class="text-sm font-semibold text-gray-500">Gelar Akademik</span>
                    <span class="text-sm font-bold text-gray-900 col-span-2" x-text="selectedGuru.gelar_akademik || '-'"></span>
                </div>
                <div class="grid grid-cols-3 py-2 border-b border-gray-50">
                ...
                <div class="grid grid-cols-3 py-2 border-b border-gray-50">
                    <span class="text-sm font-semibold text-gray-500">No Telp</span>
                    <span class="text-sm font-bold text-gray-900 col-span-2" x-text="selectedGuru.no_telp || '-'"></span>
                </div>
                <div class="grid grid-cols-3 py-2 border-b border-gray-50">
                ...
                <table class="w-full">
                    <thead class="bg-gray-900 border-b border-gray-800">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-white tracking-wider">Gelar Akademik</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-white tracking-wider">Jenis Kelamin</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-white tracking-wider">No Telp</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $g->gelar_akademik ?? '-' }}</td>
                            <td class="px-6 py-4 text-sm text-gray-700 font-medium">{{ $g->jenis_kelamin ?? '-' }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $g->no_telp ?? '-' }}</td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <x-action-buttons 
                                    ...
                                    :hapusClick="'konfirmasiHapus(' . $g->id . ', \'' . addslashes($g->nama_guru) . '\')'"
                                />
                            </td>
                        </tr>
                        @empty
